...
function initializeGlobalEventListeners() {
    ...
    // --- INICIO: LÓGICA DE SOCKET.IO PARA NOTIFICACIONES GLOBALES ---
    if (token) {
        ...
        // Listener clave para notificaciones en tiempo real
        socket.on('new_notification', (data) => {
            ...
            // Si el panel de notificaciones está abierto, lo recargamos para que aparezca la nueva
