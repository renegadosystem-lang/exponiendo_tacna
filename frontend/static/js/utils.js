// /static/js/utils.js (NUEVO ARCHIVO CENTRALIZADO)
...
function showAlert(title, message) {
    return new Promise(resolve => {
        ...
        const close = () => {
            ...
            // Clonamos y reemplazamos el botón para limpiar eventos anteriores
            okBtn.replaceWith(okBtn.cloneNode(true)); 
            resolve();
        };
        
        // Asignamos el evento al nuevo botón (o al existente la primera vez)
...
// En /static/js/utils.js, AÑADE esta función:
