// /static/js/album.js (Versión Refactorizada y Limpia)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (token) {
        try {
            ...
            localStorage.clear(); // Limpiar almacenamiento si el token es malo
    ...
    function updateInteractionState(album) {
        ...
        // Re-inicializar listeners globales para el nuevo header
    ...
    function setupEventListeners() {
        ...
        // Cerrar menú de acciones de comentario si se hace clic fuera
    ...
    // (Resto de las funciones manejadoras de eventos)
    ...
    // ... (El resto de las funciones como handleFollow, handleLike, handleSave, etc., se mantienen casi iguales,
    // solo que ahora usan las funciones globales `showAlert`, `showToast`, `showConfirm`, y `fetchWithAuth`)
    ...
    // ... y así para el resto de las funciones ...
