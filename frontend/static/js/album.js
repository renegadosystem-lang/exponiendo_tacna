document.addEventListener('DOMContentLoaded', () => {
    ...
    let state = {
        currentUserId: null,
        albumOwnerId: null,
        albumData: null, // Guardaremos los datos del álbum aquí para reutilizarlos
    ...
    function loadMediaForManagement(media) {
        ...
        media.forEach(item => {
            ...
            // --- CORRECCIÓN CLAVE: Usar data-id para compatibilidad con SortableJS ---
    ...
    function setupEventListeners() {
        ...
        elements.ownerActionButtons.addEventListener('click', e => {
            if (e.target.matches('#manage-album-btn')) {
                openManagementModal();
            }
        });
    ...
    async function handleCommentSubmit(e) { /* ... (sin cambios) */ }
    async function handleFollow() { /* ... (sin cambios) */ }
    async function handleLike() { /* ... (sin cambios) */ }
    async function handleSave() { /* ... (sin cambios) */ }
    function handleShare() { /* ... (sin cambios) */ }
    function handleCopyLink() { /* ... (sin cambios) */ }
    async function handleReportSubmit(e) { /* ... (sin cambios) */ }
    async function handleCommentAction(e) { /* ... (sin cambios) */ }
    ...
    async function handleMediaManagementClick(e) {
        ...
        const mediaId = mediaItemEl.dataset.mediaId;
