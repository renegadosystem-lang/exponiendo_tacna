// /static/js/album.js (Versión Final con Comentarios Planos y Gestión Corregida)
        ...
        if (action === 'show-reply-form') {
            ...
            container.innerHTML = `
                <form class="reply-form" onsubmit="return false;">
                    <textarea name="text" placeholder="Respondiendo a @${replyToUsername}..." required></textarea>
        ...
        if (action === 'delete-media') {
            ...
            if (confirmed) {
                ...
                if (response.ok) { 
                    ...
                    mediaItemEl.remove();
                    // No recargamos todo el álbum para una UI más fluida
