...
#  - Corrige todos los bugs de backend identificados.
#  - Implementa todas las funcionalidades solicitadas.
#  - Organizado y comentado para mayor claridad.
# =========================================================================
import os
...
# Si DATABASE_URL no está, usa credenciales locales (asegúrate de que coincidan con tu DB)
