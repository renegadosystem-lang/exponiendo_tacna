...
def get_album(album_id):
    ...
    # <-- FIN: CÓDIGO NUEVO -->
    return jsonify({'id': album.id, 'title': album.title, 'description': album.description, 'created_at': album.created_at.isoformat(), 'views_count': album.views_count, 'user_id': album.owner.id, 'owner_username': album.owner.username, 'media': media_list, 'comments': comments_list}) # <-- INCLUIMOS comments_list EN LA RESPUESTA 
