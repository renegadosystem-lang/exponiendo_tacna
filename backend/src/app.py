# =========================================================================
#  app.py (Versión Final, Estable y Completa v2.0)
# =========================================================================
import os
...
class Report(db.Model):
    ...
    description = db.Column(db.Text, nullable=True) # <-- COLUMNA CORREGIDA
    reporter = db.relationship('User', backref='reported_albums')
